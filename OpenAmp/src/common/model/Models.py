...
#Model for table Users (for reference see SQL_init.sql)
...
#Model for table Songs (for reference see SQL_init.sql)
...
#Model for table Playlists (for reference see SQL_init.sql)
